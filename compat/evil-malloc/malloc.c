...
* Synopsis of compile-time options:
    ...
    USE_DL_PREFIX              defined
    USE_PUBLIC_MALLOC_WRAPPERS NOT defined
    USE_MALLOC_LOCK            defined
    ...
    MORECORE                   disabled (file-backed mmap is used instead)
    MORECORE_CONTIGUOUS        0
    MORECORE_CANNOT_TRIM       defined
...
#define MORECORE sbrk
#else
/* All Unix heap storage comes from the file-backed MMAP implementation. */
#define MORECORE(size) ((Void_t*)(MORECORE_FAILURE))
#endif
#endif
...
#ifndef HAVE_MREMAP
/* mremap cannot safely extend a mapping past its backing file. */
...
#ifndef WIN32
extern Void_t* evil_mmap(size_t size);
#define MMAP(addr, size, prot, flags) evil_mmap(size)
#endif
...
#if !defined(MMAP) && !defined(MAP_ANONYMOUS)
